                    ...
                    <div class="col-md-12">
                        <div class="table-wrap">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    @foreach ($ParentsComplain as $ParentsComplain)
                                        <tr>
                                            <td>{{ $ParentsComplain->ParentsName }}</td>
                                            <td>{{ $ParentsComplain->ComplainType }}</td>
                                            <td>{{ $ParentsComplain->ComplainSection }}</td>
                                            <td>{{ $ParentsComplain->message }}</td>
                                            <td>{{ $ParentsComplain->created_at }}</td>

                                            @if ($ParentsComplain->ComplainStatus == 'Pending')
                                                <td> <a type="button"
                                                        href="{{ url('AssignToMod', $ParentsComplain->id) }}"
                                            ...
                                            <td> <a type="button"
                                                    ...
                                                    href="{{ url('RemoveComplainButton', $ParentsComplain->id) }} ">Delete</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
